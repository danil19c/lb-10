...
int main(int argc, char* argv[])
{
    ...
    */
    ...
    if (diam > 0 && radi < 10000) {
        ...
        cout << endl << endl << "Диаметра и Радиуса нет в данном графе" << diam << endl;
        cout << "периферийных вершин и Центральные вершин в данном графе нет" << endl << endl;
    }
    ...
    /*
    3.* Сгенерируйте (используя генератор случайных чисел)
    матрицу смежности для ориентированного взвешенного графа G.
    Выведите матрицу на экран и осуществите процедуру поиска расстояний,
    реализованную в соответствии с приведенным выше описанием.
    */
    ...
    /*
    Модернизируйте программу так,
    чтобы получить возможность запуска %
    программы с параметрами командной
    строки (см. описание ниже).
    В качестве параметра должны
    указываться тип графа (взвешенный или нет)
    и наличие ориентации его ребер
    (есть ориентация или нет).
    */
    ...
    if ((a1 != "1" && a1 != "0") || (a2 != "1" && a2 != "0")) {
        cout << "Введенны неправильные данные" << endl;
    }
    else {
